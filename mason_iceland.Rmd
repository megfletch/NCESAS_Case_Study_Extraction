...
```{r}
#Capacity scores by attribute
ggplot(mason_iceland, aes(x = resilience_attribute, y = score_1_4)) +
  geom_col() +
  coord_flip()
...
ggplot(mason_ecological_scores, aes(x = resilience_attribute, y = score_1_4, fill = importance_of_attribute_in_study_system_high_medium_low)) +
  geom_col() +
  coord_flip() +
  labs(title = "Ecological Attribute Scores", x = "Resilience Attributes", y = "Score (1-4)") +
  theme_bw() +
  scale_fill_discrete(name = "Importance", labels=c("High", "Medium", "Low"))

#scale_fill_manual("legend", values = c("High" = "green", "Medium" = "yellow", "Low" = "Red"))
ggplot(mason_socioeconomic_scores, aes(x = resilience_attribute, y = score_1_4)) +
  geom_col() +
  coord_flip() +
  labs(title = "Socioeconomic Attribute Scores", x = "Resilience Attributes", y = "Score (1-4)") +
  theme_bw() 

ggplot(mason_governance_scores, aes(x = resilience_attribute, y = score_1_4)) +
  geom_col() +
  coord_flip() +
  labs(title = "Governance Attribute Scores", x = "Resilience Attributes", y = "Score (1-4)") +
  theme_bw()
```
