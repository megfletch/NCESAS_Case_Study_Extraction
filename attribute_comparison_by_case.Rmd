...
ggplot() +
  ...
  geom_hline(data=population_abundance, aes(yintercept = mean(numeric_importance)), linetype="dashed") +
  geom_hline(data=population_abundance, aes(yintercept = mean(official_score)), linetype="dashed", colour="blue") +
  theme_bw() + my_theme  
```
