...
##### The socre means of each attribute are reflected in the table below as well as by the dashed lines in each graph below
...
means_merged_by_case <- cbind(aguion_mean,dickey_collas_mean, eurich_mean, free_mean, friedman_mean, kleisner_mean)

# Add all of the mean score columns to original total mean dataset
mean_scores_across_cases <- cbind(domain_mean, means_merged_by_case[c("Aguion","Dickey_Collas","Eurich", "Free","Friedman","Kleisner")])
```
...
# Count the numner of Importance levels by attribute
