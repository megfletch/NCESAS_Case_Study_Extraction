...
dimension_quality_merged <- cbind(aguion_dim, dickey_collas_dim, eurich_dim, free_dim, friedman_dim, hollowed_dim,  kleisner_dim, lau_dim, mason_dim, mills_dim, pecl_dim, tokunaga_dim, westfall_dim, zhao_dim) %>% 
  select(Dimension, Aguion, Dickey_Collas, Eurich, Free, Friedman, Hollowed, Kleisner, Lau, Mason, Mills, Pecl, Tokunaga, Westfall, Zhao) 
...
# Merge all mean datasets together
means_merged_by_case <- cbind(aguion_dom, dickey_collas_dom, eurich_dom, free_dom, friedman_dom, hollowed_dom,  kleisner_dom, lau_dom, mason_dom, mills_dom, pecl_dom, tokunaga_dom, westfall_dom, zhao_dom) %>% 
  select(dimension...1, domain...2, Aguion, Dickey_Collas, Eurich, Free, Friedman, Hollowed, Kleisner, Lau, Mason, Mills, Pecl, Tokunaga, Westfall, Zhao) %>% 
