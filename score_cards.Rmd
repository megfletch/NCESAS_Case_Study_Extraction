...
# I think we will want to merge the data frames horizonatlly as shown above and then use the mean function to reveal the means across the data sets and then pull out the total means of each if possible - doing the across the domains
```
