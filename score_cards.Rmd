...
eurich_plot <- ggplot() +
  ...
  geom_point(data=eurich_clam, mapping=aes(x=score, y=attribute, color=domain, alpha=quality, shape=importance), size =3, inherit.aes = F) +
  # Limits
...
## Madang PNG Coral Reef Resilience Score Card
